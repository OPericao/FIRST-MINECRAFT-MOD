package net.pericles.firstmod.block;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> BLOQUE_ZAFIRO = registerBlock("bloque_zafiro",
            () -> new Block(BlockBehaviour.Properties.copy(Blocks.SAND).ignitedByLava().explosionResistance(100).sound(SoundType.AMETHYST)));
